/*
Zuse Theme compiler for Obsidian

MIT License
Copyright (c) 2022 - 2023 Max van Essen (@Maxymillion)
...
Based on Minimal Theme's compiler.
2020-2021 Stephan Ango (@kepano)
...
module.exports = function(grunt) {
    grunt.initConfig({
        ...
        concat_css: {
            dist: {
                files: {
                    'theme.css': ['src/css/license.css','src/css/main.min.css','src/css/plugin-compatibility.css']
                }
            },
            unminified: {
                files: {
                    'Thread.css': ['src/css/license.css','src/css/main.css','src/css/plugin-compatibility.css']
                }
            }
        },
